"""Haze1k remote sensing dehazing (thin, moderate, thick)."""
import random
...
class Haze1kDatasetBase(DatasetBase):
    """Haze1k dehazing base."""
...
class Haze1kThinDataset(Haze1kDatasetBase):
    pass


class Haze1kModerateDataset(Haze1kDatasetBase):
    pass


class Haze1kThickDataset(Haze1kDatasetBase):
    pass
