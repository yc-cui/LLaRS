"""RRSHID remote sensing dehazing (thin, moderate, thick fog)."""
import random
...
class RrshidDatasetBase(DatasetBase):
    """RRSHID dehazing base."""
...
class RrshidThinDataset(RrshidDatasetBase):
    pass


class RrshidModerateDataset(RrshidDatasetBase):
    pass


class RrshidThickDataset(RrshidDatasetBase):
    pass
