"""SEN12MSCR cloud removal (single-module variant)."""
import random
...
class Sen12mscrDataset(DatasetBase):
    """
    SEN12MSCR: inp = concat(s2_cloudy, s1) 15 ch; gt = cloud-free s2, 13 ch; add = s2_cloudy 13 ch.
    """
