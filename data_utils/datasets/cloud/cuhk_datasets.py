...
class CuhkDatasetBase(DatasetBase):
    """C-CUHK cloud removal base (CR1 and CR2)."""
...
class CuhkCr1Dataset(CuhkDatasetBase):
    pass


class CuhkCr2Dataset(CuhkDatasetBase):
    pass
