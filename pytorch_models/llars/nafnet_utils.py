...
class NAFBlock(nn.Module):
    ...
    def __init__(self, c, DW_Expand=2, FFN_Expand=2, drop_out_rate=0.):
        ...
        self.conv2 = nn.Conv2d(in_channels=dw_channel, out_channels=dw_channel, kernel_size=3,
        ...
        self.sca = nn.Sequential(
            ...
            nn.Conv2d(in_channels=dw_channel // 2, out_channels=dw_channel // 2,
        ...
        self.conv4 = nn.Conv2d(in_channels=c, out_channels=ffn_channel, kernel_size=1,
                               padding=0, stride=1, groups=1, bias=True)
        self.conv5 = nn.Conv2d(in_channels=ffn_channel // 2, out_channels=c, kernel_size=1,
                               padding=0, stride=1, groups=1, bias=True)
